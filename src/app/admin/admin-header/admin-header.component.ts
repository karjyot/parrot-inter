...
export class AdminHeaderComponent implements OnInit {
  ...
  constructor(@Inject(WINDOW) private window: Window, private adminService: AdminService,private modalService: BsModalService,private formBuilder:FormBuilder,private ngxService: NgxUiLoaderService,private toastr: ToastrService,private router : Router,) { }

  ngOnInit() {
    $(this.window).resize(function() {
      if($(this.window).width() <= 567) {
          // if larger or equal
